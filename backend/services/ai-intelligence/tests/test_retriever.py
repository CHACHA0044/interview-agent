...
- RetrievedChunk is contract-shaped (day, title, objectives, tools, score).
"""
...
def test_retrieve_success():
    ...
    assert result.chunks[0].day == 1
    assert result.chunks[0].title == "Setup"
    ...
    result = RetrievalResult(
        ...
        chunks=[
            RetrievedChunk(
                day=12,
                title="RAG",
                objectives=["First chunk text."],
                score=0.9
            ),
            RetrievedChunk(
                day=15,
                title="Evaluation",
                objectives=["Second chunk text."],
                score=0.8
            )
        ],
        total_found=2
